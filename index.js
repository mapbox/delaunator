...
for (var k = 0; k < ids.length; k++) {
    ...
    while (area(x, y, q.x, q.y, q.next.x, q.next.y) < 0) {
        ...
        linkAdjacent(t, q.prev.t);
        adjacent[t + 1] = -1;
        linkAdjacent(t + 2, q.t);
    ...
    while (area(x, y, q.prev.x, q.prev.y, q.x, q.y) < 0) {
        ...
        adjacent[t] = -1;
        linkAdjacent(t + 1, q.t);
        linkAdjacent(t + 2, q.prev.t);
...
console.log('hull size ' + hullSize);
